...
function iniciaJogo(){
    ...
    // Verifique se o elemento de áudio foi encontrado
    if (musica) {
        musica.play();
    }
...
function remove_eventos_baloes () {
	...
	//percorre os elementos de acordo com o id e só irá sair do laço quando não houver correspondência com o elemento
